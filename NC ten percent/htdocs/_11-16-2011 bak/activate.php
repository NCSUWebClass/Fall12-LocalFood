...
<div id="secondary">
	...
	if (__calculate_activation_hash($pkey) == $hash || $_GET['ok']) {
		...
		if ((mysql_errno() == 0 && mysql_affected_rows() == 1) || $_GET['ok']) {
			...
			} else echo '<h2>There was an error activating your account. Please contact us.</h2>';
		} else {
 			echo "<h2>Already Activated?</h2><p>There was an error activating your account. Maybe it has already been activated. Please contact us if you need assistance.</p>";
		}
	} else {
