<?php include('header.php'); ?>
		<div id="seasonality-how-it-works">
			...
			<div id="about">
				...
				<br />
				<p><span style="font-size: x-large; color: #ddd;">spent</span>&nbsp;&nbsp;&nbsp;<span style="font-size: xx-large; font-weight: bold; color: white;"><?php echo __get_total_dollar_amount();?></span>&nbsp;&nbsp;&nbsp;<span style="font-size: x-large; color: #ddd;">locally</span><br /><br /><span style="font-size:small; color: #ddd; font-style:italic;">updated weekly</span></p>
				<br />
