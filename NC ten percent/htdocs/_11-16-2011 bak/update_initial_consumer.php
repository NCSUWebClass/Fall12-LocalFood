...
<br /><br />
-->
<h3>Let's Get Started on updating your initial information</h3>

<form id="myform" action="update_initial_submit.php" method="post" accept-charset="utf-8">
	...
	<input type="hidden" name="heard_about_campaign" value="<?php echo __get_member_field_initial_survey($pkey, 'heard_about_campaign')?>" id="heard_about_campaign">
	<input type="hidden" name="heard_about_campaign_other" value="<?php echo __get_member_field_initial_survey($pkey, 'heard_about_campaign_other')?>" id="heard_about_campaign_other">
...
-->		
		<tr>
			...
			<td width="35%"><?php __create_select_options(__get_list_type("HOUSEHOLD"), "household", true, __get_member_field_initial_survey($pkey, 'household')); ?></td>
		</tr>
		...
		<tr align="top">
			...
			<td width="35%"><input class="digits" type="text" name="weekly_spend_amount" value="<?php echo __get_member_field_initial_survey($pkey, 'weekly_spend_amount')?>" id="weekly_spend_amount" size="5"></td>
		</tr>
		<!--
		<tr>
		...
		<tr>
			...
			<td><p><?php __create_checkbox_options(__get_list_type("SOURCE"), "regular_local_sources",__get_member_field_initial_survey($pkey, 'regular_local_sources')); ?></p></td>
		</tr>
		<!--
		<tr>
