...
if (__is_business($pkey)) {
	...
	$result = __do_sql("update members set active = '$active', bname = '$bname', btype = '$btype', statewide = '$statewide', zipcode = '$zipcode', name = '$name', email = '$email' where pkey = '$pkey' LIMIT 1");
