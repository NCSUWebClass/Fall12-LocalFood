...
foreach($sources as $k => $v) {
	...
	*/
	...
	echo "<br /><p>Explore the <a href=\"local.php\">Find Local Food</a> page for more ideas on where to eat, buy, or grow local. Take me back to my <a href=\"dashboard.php?wp=$weekly_pkey&p=$pkey&h=$hash\">progress page</a>.</p>";
