<h1>Hello<?php $name = __get_member_field($pkey, 'name'); if ($name) echo " $name";?>!</h1>
<p>
	Thank you for joining the 10% Campaign.
</p>

<br /><br />
<p class="introtext">Why 10 percent?</p>
<p>
...
<br /><br />
<p class="introtext">Help us track our statewide progress!</p>
<p>
...
<br /><br />
<p class="introtext">Let's Get Started</p>
...
<form id="myform" action="activate_submit.php" method="post" accept-charset="utf-8">
	...
	<table border="0" cellspacing="5" cellpadding="5">
		...
		-->
		<tr>
			<td>Where do you find locally produced food? Check all that apply:<br /><br />* Growing your own food counts toward your local food purchases.</td>
