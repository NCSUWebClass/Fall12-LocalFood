...
<p class="gray">
	...
	<a href="add_chain.php">Add a new business chain</a> &raquo; <span style="font-size:smaller;">Add a new chain of businesses</span><br />
	...
	<form action="reportcounty.php" method="post" accept-charset="utf-8">
		  Generate LFC report for <?php echo 'County'; __create_select_options(__get_list_type("COUNTY"),"county",true); echo '&nbsp;';echo 'Month '; __create_select_options(__get_list_type("MONTH"),"month",true); echo '&nbsp;'; echo 'Year '; __create_select_options(__get_list_type("YEAR"),"year",true); ?>
		<input type="submit" value="Generate">
                    <h6>(This might take a few minutes)</h6>
		</form>
	...
	<?php if (__is_admin_user()) { ?>
		...
		<a href="analytics.php">Google Analytics</a> &raquo; <span style="font-size:smaller;">reports and statistics</span><br />
		...
		<form action="_table2csv.php" method="post" accept-charset="utf-8">
			...
			<select name="table" id="table">
				<option value="business_chain">business_chain</option>
		...
		<form action="report.php" method="post" accept-charset="utf-8">
		  Generate consumer LFC report for <?php echo 'Month '; __create_select_options(__get_list_type("MONTH"),"month",true); echo '&nbsp;'; echo 'Year '; __create_select_options(__get_list_type("YEAR"),"year",true); ?>
		<input type="submit" value="Generate">
		</form>
		<form action="report1.php" method="post" accept-charset="utf-8">
		  Generate LFC business and restaurant report for <?php echo 'Month '; __create_select_options(__get_list_type("MONTH"),"month",true); echo '&nbsp;'; echo 'Year '; __create_select_options(__get_list_type("YEAR"),"year",true); ?>
		<input type="submit" value="Generate">
		</form>
