...
<p class="gray">
	...
	<?php if (__is_admin_user()) { ?>
		...
		<form action="report.php" method="post" accept-charset="utf-8">
		  Generate LFC report for <?php echo 'Month '; __create_select_options(__get_list_type("MONTH"),"month",true); echo '&nbsp;'; echo 'Year '; __create_select_options(__get_list_type("YEAR"),"year",true); ?>
