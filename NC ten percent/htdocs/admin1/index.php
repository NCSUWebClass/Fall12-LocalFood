<?php include('header.php'); ?>
		<div id="seasonality-how-it-works">
			...
			<div id="belowfold" style="position:absolute; top:328px; width:920px; z-index:-1; padding:80px 20px;">
                ...
                <div id="tabs" style="background-color:#FFF">
					...
					<h3 style="color:#color: #034B72; font-family:Arial, Helvetica, sans-serif; font-size:20px; font-style:normal; font-weight:bold">News &amp; Happenings</h3>
                    <ul>
						<?php if ($_GET['county']) { ?>
...
//echo CEFS_RSS_FEED;
						...
						if (count($arrFeeds)) {
							...
							echo '<br style="clear:both;" />';
		                        echo '<p style="color: #333333; font-size: 14px; line-height: 20px; padding: 7px 0;"><span style="font-weight:bold;">10% Campaign reaches $10 million spent on local food</span><br />';
								echo 'November 21, 2011 Press Release';
								echo '<br /><a href="http://www.cals.ncsu.edu/agcomm/news-center/extension-news/10-campaign-reaches-10-million-spent-on-local-food/">Read Complete Article</a>';
								echo '</p>';
						
							echo '<br style="clear:both;" />';
		                    echo '<p style="color: #333333; font-size: 14px; line-height: 20px; padding: 7px 0;"><span style="font-weight:bold;">Just One Year in CEFS Campaign Tracks $5.7 Million in Local Food Purchases</span><br />';
							...
							foreach ($foundRSSArray as $k => $foundRSS) {
								echo '<br style="clear:both;" />';
		                        echo '<p style="color: #333333; font-size: 14px; line-height: 20px; padding: 7px 0;"><span style="font-weight:bold;">'.$foundRSS['title'].'</span><br />';
							...
							echo '<br style="clear:both;" />';
	                        echo '<p style="font-weight:bold; color: #333333; font-size: 14px; line-height: 20px; padding: 7px 0;">Latest News</p>';
							echo '<p style="color: #333333; font-size: 14px; line-height: 20px; padding: 7px 0;">Please visit the CEFS web site for the latest news on local food. <a href="http://www.cefs.ncsu.edu/recentnews.html">Read more</a></p>';
						}
?>
...
?>
				...
				<div id="socialmedia">
					<h3 style="color:#color: #034B72; font-family:Arial, Helvetica, sans-serif; font-size:20px; font-style:normal; font-weight:bold">Social Media</h3>
