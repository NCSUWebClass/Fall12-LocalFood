...
<div id="belowfold">
<div id="secondary">
	<h2>Hi<?php $name = __get_member_field($pkey, 'name'); if ($name) echo " $name";?>, let's record this week's data!</h2>
	<br /><br />
	<?php 
		...
		// CONSUMERS ------------------------------------------->
		$consumer_table = __get_consumers_history('27604',6,$pkey);
        ...
        <div class="consumer-chart">
            ...
            <?php } ?>    
            <p>Last week, your county's average was: <span class="figure">$<?php echo money_format('%i', $avg1) ?></span><br /> while you spent: <span class="figure">$<?php echo money_format('%i', $ct[1]) ?></span></p>
            <p>There were <span class="figure"><?php echo $week1; ?></span> people who reported in your County last week.</p><br />
            <p><span style="font-size: x-large; font-weight: bold; color: #82317c;"><?php echo __get_total_dollar_amount();?></span>&nbsp;<span style="color: #333;">raised so far</span></p>
            </div>
		</div>	
        
        
     	<?php /* imported from weekly_consumer.php ---------------------------------------- */ ?>
