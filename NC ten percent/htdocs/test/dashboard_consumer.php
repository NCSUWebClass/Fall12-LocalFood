...
//======================		
	...
	{	
		...
		$sql = "SELECT members.pkey, members.name, consumer_data_weekly.fkey, consumer_data_weekly.answered_on, consumer_data_weekly.amount FROM members INNER JOIN consumer_data_weekly ON members.pkey = consumer_data_weekly.fkey AND members.kind = 'consumer' AND members.pkey = ".$pkey." AND (UNIX_TIMESTAMP(consumer_data_weekly.answered_on) > (UNIX_TIMESTAMP()-(604800*13))) ORDER BY consumer_data_weekly.answered_on";
		//myProgress--------------------------------------------->
		...
		// CONSUMERS ------------------------------------------->
              ...
              // this sql is probably completely bogus
              // i have no way of knowing...
              $sql2 = "SELECT members.pkey, members.name, consumer_data_weekly.fkey, consumer_data_weekly.answered_on, consumer_data_weekly.amount FROM members INNER JOIN consumer_data_weekly ON members.pkey = consumer_data_weekly.fkey AND members.kind = 'consumer' AND members.pkey = ".$pkey." AND (UNIX_TIMESTAMP(consumer_data_weekly.answered_on) > (UNIX_TIMESTAMP()-(604800*7))) ORDER BY consumer_data_weekly.answered_on";
        ...
        <div class="consumer-chart">
            ...
            <?php if ($ct_current > 0) { ?>
            	<p class="intro">Keep up the progress!<br /><br /></p>
            <?php } else { ?>
            	<p class="intro">This week's current statistics:<br /><br /></p>
            <?php } ?>
            <?php
            if($compare_me == household){    
            	echo "<p class=\"dashboard\">This week, <span class=\"figure\">\$"?><?php echo money_format('%i', $avg_current) ?><?php echo "</span> has been the average for people with the same household size";
            	if ($ct_current > 0) { 
            		echo", while you spent: <span class=\"figure\">\$"?><?php echo money_format('%i', $ct_current)?><?php echo "</span></p><br />";
                } else { 
                	echo ".</p>";
            	} 
            	...
            	echo "<p class=\"dashboard\">This week, your county's average has been: <span class=\"figure\">\$"?><?php echo money_format('%i', $avg_current) ?><?php echo "</span>";
            	if ($ct_current > 0) {
            		echo"<br /> while you spent: <span class=\"figure\">\$"?><?php echo money_format('%i', $ct_current) ?><?php echo "</span></p><br />";
                } else { 
                	echo ".</p>";
                }	            		
            	...
            	echo "<p class=\"dashboard\">This week, <span class=\"figure\">\$"?><?php echo money_format('%i', $avg_current) ?><?php echo "</span> has been the average for people with the same zipcode";
            	if ($ct_current > 0) {
            		echo", while you spent: <span class=\"figure\">\$"?><?php echo money_format('%i', $ct_current)?><?php echo "</span></p><br />";
                } else { 
                	echo ".</p>";
            	}            	
            	//echo "<p>There were <span class=\"figure\">$week1</span> people in your community who participated last week.</p><br />";
