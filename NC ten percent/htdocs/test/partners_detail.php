...
if ($col=='red')
{
  ...
  echo '<br><br><i>Want to view by county?</i> Choose here: &nbsp;';
  echo '<form name="counties" action="county_detail.php" method="get">';
  echo '<input type="hidden" name="color" value="red">';
  echo '<select name="county" onchange="this.form.submit()">';
  echo '<option id="alamance">Alamance</option>';
  echo '<option id="caswell">Caswell</option>';
  echo '<option id="chatham">Chatham</option>';
  echo '<option id="davidson">Davidson</option>';
  echo '<option id="durham">Durham</option>';
  echo '<option id="forsyth">Forsyth</option>';
  echo '<option id="franklin">Franklin</option>';
  echo '<option id="granville">Granville</option>';
  echo '<option id="guilford">Guilford</option>';
  echo '<option id="orange">Orange</option>';
  echo '<option id="person">Person</option>';
  echo '<option id="randolph">Randolph</option>';
  echo '<option id="rockingham">Rockingham</option>';
  echo '<option id="stokes">Stokes</option>';
  echo '<option id="vance">Vance</option>';
  echo '<option id="wake">Wake</option>';
  echo '<option id="warren">Warren</option>';
  echo '</select>';
  echo '</form>';
}
if ($col=='yellow')
