...
//    if (mysql_errno() == 0 && mysql_affected_rows() == 1) { 
	...
	*/
	...
	echo "<br /><p>Explore the <a href=\"local.php\">Find Local Food</a> page for more ideas on where to eat, buy, or grow local. Take me back to my <a href=\"dashboard_n4.php?wp=$weekly_pkey&p=$pkey&h=$hash\">progress page</a>.</p>";
